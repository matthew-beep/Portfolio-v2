    ...
    <footer className='flex flex-col w-full h-auto items-center text-white pt-20 gap-4 overflow-x-hidden'>
      <section className='w-9/12 flex flex-col lg:flex-row'>
        <div className='flex flex-col gap-4 mb-10 lg:mb-0 w-full lg:w-1/2 font-inter'>
          ...
          <p className='lg:w-8/12 text-xl w-full font-inter'>
          ...
          <div className='flex gap-4 font-poppins font-normal mt-7'>
            <Link 
        ...
        <div className='w-full lg:w-1/2 relative'>
          <div className='w-full h-full relative z-40 glassmorphic rounded-lg'>
            <form className='w-full h-full p-5 text-[#161B22] font-poppins relative z-20'>
              <input type="text" placeholder='Your Name' className='w-full p-2 focus:ring-[#7B4EE6] rounded-lg bg-white' />
              <input type="email" placeholder='Your Email' className='w-full p-2 mt-4 rounded-lg bg-white' />
              <textarea placeholder='Your Message' className='w-full p-2 mt-4 rounded-lg bg-white' rows='4'></textarea>
              <button className='w-full p-2 mt-2 text-white font-bold text-xl bg-[#7B4EE6] hover:bg-[#553B97] rounded-lg duration-500'>Send Message</button>
            </form>
          </div>

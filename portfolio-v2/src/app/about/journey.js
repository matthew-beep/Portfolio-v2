...
export default function Journey() {
  ...
  return (
    <div className="text-white flex flex-col gap-4 font-inter text-lg border-2 w-10/12 text-xl">
      <p>
      ...
      <p>
        Currently, I am working as a User Interface Engineer, for ATS Automation, where I design interface standards and templates for 
        ...
        I have worked with and built interfaces for clients such as the Seattle Public Schools system and Fred Hutch Cancer Center Campus. 
      </p>
      <p>
